...
const WritingPage = () => {
  return (
    <div className="min-h-screen bg-[#f9f6f0] px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {/* Charwe */}
        <Link href="/charwe" className="group border rounded-2xl p-6 bg-white shadow hover:shadow-lg transition">
        ...
        >
          ...
          <p className="text-[#6b4f3b] mt-2">
            A selection of my poems featured in Zimbabwe’s premier poetry journal.
          </p>
        </a>

        {/* Other Poems */}
        <Link href="/poetry" className="group border rounded-2xl p-6 bg-white shadow hover:shadow-lg transition">
          <h2 className="text-2xl font-semibold text-[#4b3832] group-hover:underline">
            Other Poems
          </h2>
          <p className="text-[#6b4f3b] mt-2">
            A growing archive of my poetic experiments, musings, and pieces rooted in memory, spirituality, and African cosmology.
          </p>
        </Link>
      </div>
    </div>
